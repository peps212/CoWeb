...
<section class=" bg-gradient-to-r from-indigo-500 to-indigo-900 body-font h-max">
  ...
  <h1 class="title-font mobile:text-xl sm:text-4xl text-3xl mb-4 font-bold text-white">Real-Time Collaboration On Any Web App:<br></br><span className="mobile:text-sm sm:text-2xl lg:text-3xl text-3xl"> Revolutionize <span ref={TypedElement}></span></span> </h1>
